...
--4. Select all users that have attempted 9 or more transactions_attempted:
SELECT * FROM syntax_practice WHERE transactions_attempted >= 9;

--5. Get the username and account balance of the 3 users with the highest account balances, sort highest to lowest balance:
SELECT username, account_balance FROM syntax_practice ORDER BY account_balance DESC LIMIT 5
...
--8. Add a new record:
INSERT INTO syntax_practice (username, city, transactions_completed, transactions_attempted, account_balance) VALUES ('ally', 'minneapolis', '1000', '25', '1000000');
